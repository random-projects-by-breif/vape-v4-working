...
```luau
loadstring(game:HttpGet("https://raw.githubusercontent.com/random-projects-by-breif/vape-working/refs/heads/main/NewMainScript.lua", true))()
```
...
2. Making sure you have connection to [the main loadstring.](loadstring(game:HttpGet("https://raw.githubusercontent.com/random-projects-by-breif/vape-working/refs/heads/main/NewMainScript.lua", true))())
